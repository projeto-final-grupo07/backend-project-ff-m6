...
import { IAddressUpdate, IUserCreate, IUserUpdate } from '../../interfaces/User';
...
import UpdateUserAddressService from '../../services/User/update.userAddress.service';
...
export const UpdateUserAddressController = async (req: Request, res: Response) => {
  ...
  const updatedUser = await UpdateUserAddressService(data, userId);
